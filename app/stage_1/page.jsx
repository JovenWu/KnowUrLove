...
import Stage1_1 from "/public/assets/images/Stage1_1.svg";
import Stage1_2 from "/public/assets/images/Stage1_2.svg";
import Stage1_3 from "/public/assets/images/Stage1_3.svg";
import Stage1_4 from "/public/assets/images/Stage1_4.svg";
import Stage1_5 from "/public/assets/images/Stage1_5.svg";
import one01 from "/public/assets/prog/one01.svg";
import one02 from "/public/assets/prog/one02.svg";
import one03 from "/public/assets/prog/one03.svg";
import one04 from "/public/assets/prog/one04.svg";
import one05 from "/public/assets/prog/one05.svg";
  ...
  return (
    <div className="flex flex-col items-center max-w-xs mx-auto mt-8">
      ...
      <div className="flex items-center">
        <Image src={image} alt="Ilustrasi ekspresi" />
        {questions.length > 0 && (
          <h3 className=" bg-[#c2b29b] w-[187px]   text-stone-600 text-xs rounded-[12px] px-2 py-2">
